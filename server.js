...
// Session config — stored in PostgreSQL so sessions survive restarts
app.use(session({
...
// Fetch all data (with optional date range filter)
...
// Bulk sync (for offline queue — accepts array of submissions)
...
// Serve manifest, service worker, and the app
